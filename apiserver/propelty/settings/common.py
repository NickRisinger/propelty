...
if bool(os.environ.get("DATABASE_URL")):
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.environ.get("POSTGRES_DB", "github-actions"),
            "USER": os.environ.get("POSTGRES_USER", "github-actions"),
            "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "github-actions"),
